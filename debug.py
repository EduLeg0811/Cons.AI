# start_debug.py — DEV local com suporte a breakpoints (Flask + HTTP estático)
import os
import sys
import threading
import webbrowser
...
# 🔹 Adiciona suporte ao debug remoto
import debugpy
debugpy.listen(("127.0.0.1", 5678))  # porta padrão para attach
print("🟢 Debugger escutando em 127.0.0.1:5678, aguardando conexão...")
debugpy.wait_for_client()  # pausa até Windsurf/VSCode conectar
...
def main():
    # Garante que o backend/ está no sys.path
    ...
    # Importa o Flask app do backend
